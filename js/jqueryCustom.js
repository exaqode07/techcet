	...
	function initProgressBar() {
		if( jQuery(".progress-bar").length != '' ){
			var waypoint = new Waypoint({
				element: document.getElementById('progress-bar, progress-bar1, progress-bar2, progress-bar3, progress-bar4, progress-bar5, progress-bar6, progress-bar7, progress-bar8, progress-bar9, progress-bar10, progress-bar11'),
...
window.onload = function() {
	var ctx = document.getElementById("graph-chart-box").getContext("2d");
...
$('.report-tabs').click(function(){	
	...
	$('.report-type').removeClass('report-type-shadow');
	$(this).closest('.report-type').addClass('report-type-shadow');	
});
...
/*****thumbnail-all-report-jquery-code*****/
jQuery(document).ready(function ($) {
	$('.thumb-img a').on("click", function(e){
		e.preventDefault();
		$('.slider-items-box img').attr("src", $(this).attr("href"));
	});
	
	document.getElementById("thumb-img").style.height = "634px";

});



$(".recent-mobilebox").click(function(){
  $(".mobile-nav-overlay").show();
  $(".mobile-nav-set-overlay").hide();
});
$(".recent-box-popup i").click(function(){
  $(".mobile-nav-overlay").hide();
});

$(".setting-mobile-menu").click(function(){
  $(".mobile-nav-set-overlay").show();
  $(".mobile-nav-overlay").hide();
});
$(".setting-box-pupop i").click(function(){
  $(".mobile-nav-set-overlay").hide();
});
...
// report page thumbnail sidebar dynamic height
$(window).resize(function(){	
	let img = document.getElementById('img-height');
	var imgHeight = img.clientHeight; 	
	document.getElementById("thumb-img").style.height = imgHeight+"px";	
});
